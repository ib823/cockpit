...
## SAP Cockpit - Comprehensive Component & Pattern Audit
...
This document provides a **complete inventory** of all UI components, design patterns, typography, spacing, animations, and visual assets used across the SAP Cockpit application. This serves as the foundation for building a proprietary UI toolkit.
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
  {stats.map(stat => <StatCard key={stat.name} />)}
</div>
```
...
**Date:** 2025-10-20
**Codebase:** SAP Cockpit (/workspaces/cockpit)
