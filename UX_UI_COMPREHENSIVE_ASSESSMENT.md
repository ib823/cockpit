...
```javascript
animations: {
  ("fade-in", "slide-up", "slide-down", "shake", "focus-glow", "pulse-slow");
}
```
...
> — Ethan Marcotte, _Responsive Web Design_
...
> — Luke Wroblewski, _Web Form Design_
...
> — Sheena Iyengar, _The Paradox of Choice_
...
> — Luke Wroblewski, _Mobile First_
