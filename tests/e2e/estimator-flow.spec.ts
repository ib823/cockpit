...
test.describe('Estimator Complete Workflow', () => {
  ...
  test('should complete full estimation workflow', async ({ page }) => {
    ...
    await page.click('[data-testid="l3-item"]:has-text("Accounting") input[type="checkbox"]', { timeout: 5000 });
    await page.click('[data-testid="l3-item"]:has-text("Accounts Receivable") input[type="checkbox"]', { timeout: 5000 });
    await page.click('[data-testid="l3-item"]:has-text("Accounts Payable") input[type="checkbox"]', { timeout: 5000 });
