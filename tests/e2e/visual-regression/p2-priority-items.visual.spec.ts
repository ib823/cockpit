...
test.describe("P2-2: Month Labels on Bars", () => {
  ...
  test("desktop: timeline header SHOULD have month labels", async ({ page }) => {
    ...
    const timelineHeader = page.locator(
      '[data-testid="timeline-header"], [class*="timeline-header"]'
    );
...
test.describe("P2-24: Zero Data Everywhere", () => {
  ...
  test("desktop: mission control with empty project shows helpful empty state", async ({
    page,
  }) => {
