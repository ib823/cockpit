...
export default function RecoveryRequestsPage() {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      setSuccess(`Recovery request approved. User will receive an email with recovery instructions.`);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600">Review and approve account recovery requests from users</p>
          </div>
          <button
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <span className="font-medium text-slate-900">{formatReason(request.reason)}</span>
                        </div>
                        <div>
                          <span className="text-slate-500">Submitted:</span>{' '}
                          <span className="font-medium text-slate-900">{formatDate(request.submittedAt)}</span>
                        </div>
                        {request.notes && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-2xl w-full p-8">
            ...
            <p className="text-slate-600 mb-6">
              You are about to approve the recovery request for <strong>{selectedRequest.user.email}</strong>.
              This will:
            </p>
      ...
      {showRejectModal && selectedRequest && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-2xl w-full p-8">
            ...
            <p className="text-slate-600 mb-6">
              You are about to reject the recovery request for <strong>{selectedRequest.user.email}</strong>.
            </p>
