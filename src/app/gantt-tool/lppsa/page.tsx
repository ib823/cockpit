...
const lppsaProjectData = {
  ...
  description: "Dual-track SAP S/4HANA implementation project covering technical conversion and new module implementations",
          ...
          <Row gutter={16}>
            <Col span={6}>
              <Card>
                <Statistic
                  title="Phases"
                  value={lppsaProjectData.phases.length}
                />
              </Card>
            </Col>
            <Col span={6}>
            ...
            <Col span={6}>
              <Card>
                <Statistic
                  title="Milestones"
                  value={lppsaProjectData.milestones.length}
                />
              </Card>
            </Col>
            <Col span={6}>
          ...
          <Card title="Project Overview">
            <Space direction="vertical" className="w-full">
              ...
              <div className="p-4 bg-blue-50 rounded border-l-4" style={{ borderColor: '#3B82F6' }}>
                ...
                <p className="text-xs text-gray-600 mt-1">Technical Conversion, Remediation, Mandatory Fiori App to replace obsolete transactions</p>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded border-l-4" style={{ borderColor: '#10B981' }}>
                ...
                <p className="text-xs text-gray-600 mt-1">New modules implementation, enhancement and business transformation</p>
              </div>
