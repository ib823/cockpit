  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="text-center max-w-4xl mx-auto px-4">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">SAP Implementation Cockpit</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          ...
          <Link href="/presales" className="group">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-gray-600 text-sm">
                Extract requirements from RFPs, make key decisions, and generate proposals in
                minutes
              </p>
              <div className="mt-4 text-blue-600 font-medium text-sm">Launch Presales →</div>
            </div>
          </Link>
          ...
          <div className="group opacity-50 cursor-not-allowed">
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="text-4xl mb-4">📊</div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Timeline Configurator</h2>
              <p className="text-gray-600 text-sm">
