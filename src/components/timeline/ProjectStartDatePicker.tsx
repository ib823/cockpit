          ...
          <div className="space-y-2 mb-4">
            {validation.isWeekend && (
              <div className="flex items-start gap-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-yellow-800">Weekend Selected</div>
            ...
            {validation.isHoliday && (
              <div className="flex items-start gap-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-red-800">Public Holiday</div>
            ...
            {validation.isValid && (
              <div className="flex items-start gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-green-800">Valid Working Day</div>
