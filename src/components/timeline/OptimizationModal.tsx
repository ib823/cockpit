              ...
              <div className="w-full space-y-3">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm pt-2 border-t">
                  ...
                  <div>
                    ...
                    <div
                      className={`font-semibold ${suggestion.costImpact > 0 ? "text-red-600" : "text-green-600"}`}
                    >
                      {suggestion.costImpact > 0 ? "+" : ""}$
                      {Math.abs(suggestion.costImpact).toLocaleString()}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {suggestion.riskScore > 3 && suggestion.riskScore <= 6 && (
        ...
        <Alert
          ...
          description={
            <ul className="text-sm space-y-1 mt-2 list-disc list-inside">
              <li>
                <strong>Low risk (1-3):</strong> Safe changes, minimal coordination needed
              </li>
              <li>
                <strong>Medium risk (4-6):</strong> Requires careful management and planning
              </li>
              <li>
                <strong>High risk (7-10):</strong> Significant challenges, consider alternatives
              </li>
            </ul>
          }
          type="info"
