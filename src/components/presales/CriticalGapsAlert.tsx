  ...
  useEffect(() => {
    ...
    if (!hasDataVolume) {
      foundGaps.push({
        ...
        impactRange:
          "<1K/day = simple | 10K/day = complex | 100K+/day = architectural review needed",
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 text-xs text-gray-600">
        <strong>Why this matters:</strong> The difference between 1 and 10 legal entities can mean 6
        months vs 18 months implementation. We&apos;re making assumptions that could be wildly
        wrong.
      </div>
    </div>
  );
