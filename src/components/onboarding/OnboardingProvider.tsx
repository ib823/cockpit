...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    id: "welcome",
    title: "Welcome to SAP Implementation Cockpit! 👋",
  ...
  },
  {
    ...
    description: "Switch between Timeline, Resources, and RICEFW tabs to explore different aspects of your project plan.",
    mode: "plan",
    target: "#plan-tabs",
    position: "bottom",
  },
