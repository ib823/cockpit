...
const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  // Estimator steps
  {
    ...
    title: "SAP Estimator",
    description:
      "Configure your implementation parameters here. All calculations happen in real-time.",
    target: null,
  },
  {
    pathname: "/estimator",
  ...
  },
  {
    ...
    title: "Live Results",
    description:
      'Your estimate updates automatically as you change inputs. No need to click "Calculate"!',
  ...
  },
  {
    ...
    description:
      "When you're happy with your estimate, generate a detailed project timeline with one click.",
