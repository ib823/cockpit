          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <div
              style={{
                ...
                height: "48px",
                borderRadius: "12px",
                backgroundColor: "var(--color-blue, #0062CC)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              }}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: allocationPercent === preset.value
                          ? "2px solid var(--color-blue, #0062CC)"
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          height: "32px",
                          borderRadius: "4px",
                          backgroundColor: phase.color || "#0062CC",
                          marginRight: "12px",
                        }}
                      />
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: "14px", fontWeight: 600, color: "var(--color-blue, #0062CC)" }}>
                          {allocationPercent}%
                        </div>
                      </div>
                      <div>
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ fontSize: "18px", fontWeight: 700, color: "var(--color-blue, #0062CC)" }}>
