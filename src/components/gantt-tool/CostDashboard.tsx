...
export function CostDashboard() {
  ...
  const categoryBreakdown = Array.from(costData.costByCategory.entries()).map(
    ([category, cost]) => ({
      category,
      ...
      <Row gutter={16}>
        ...
        <Col span={6}>
          <Card className="shadow-sm">
            ...
            />
            <div className="text-xs text-gray-500 mt-2">
              Labor: {formatCurrency(costData.laborCost)}
            </div>
          </Card>
        </Col>
        ...
        <Col span={6}>
          <Card className="shadow-sm">
            <Statistic
              ...
              valueStyle={{
                color:
                  costData.budgetUtilization > 100
                    ? "#cf1322"
      ...
      <Row gutter={16}>
        ...
        <Col span={12}>
          <Card
            ...
            className="shadow-sm"
            extra={<PieChart className="w-4 h-4 text-gray-400" />}
          >
            <div className="space-y-3">
