    ...
    >
      <div>
        ...
        <div style={{ maxHeight: "400px", overflowY: "auto" }}>
          {filteredCommands.length === 0 && searchText.trim() ? (
            ...
            <div style={{ padding: "32px", textAlign: "center" }}>
              <Text type="secondary">Type to search pages and actions</Text>
            </div>
          ) : (
            <List
              ...
              renderItem={(item, index) => (
                ...
                >
                  ...
                  />
                  {index === selectedIndex && <Tag style={{ fontSize: "11px" }}>↵</Tag>}
                </List.Item>
              )}
            />
          )}
        ...
        >
          <Space size={12}>
            <span>
              <Tag style={{ fontSize: "10px" }}>↑↓</Tag> Navigate
            </span>
            <span>
              <Tag style={{ fontSize: "10px" }}>↵</Tag> Select
            </span>
            <span>
              <Tag style={{ fontSize: "10px" }}>Esc</Tag> Close
            </span>
          </Space>
