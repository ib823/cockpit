...
const envSchema = z.object({
  ...
  DATABASE_URL_UNPOOLED: z
    .string()
    .url("DATABASE_URL_UNPOOLED must be a valid PostgreSQL connection URL"),

  // NextAuth (Required)
  NEXTAUTH_SECRET: z
    .string()
    .min(32, "NEXTAUTH_SECRET must be at least 32 characters for HS256 security"),
