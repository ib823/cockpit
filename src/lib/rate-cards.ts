...
export function getDefaultTeamComposition(
  ...
  const compositions = {
    ...
    6: ['Senior Manager', 'Manager', 'Senior Consultant', 'Senior Consultant', 'Consultant', 'Analyst'],
    8: ['Senior Manager', 'Manager', 'Manager', 'Senior Consultant', 'Senior Consultant', 'Consultant', 'Consultant', 'Analyst'],
  };
