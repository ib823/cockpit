...
export function createDefaultResources(): Resource[] {
  ...
  return [
    ...
    createResource(
      ...
      "functional",
      "principal",
      "End-to-end solution design across all SAP modules"
    ),
    createResource(
      "SAP FI/CO Lead",
      "functional",
      "senior_manager",
      "Finance & Controlling workstream lead"
    ),
    createResource(
      "SAP MM/SD Manager",
      "functional",
      "manager",
      "Materials Management & Sales Distribution manager"
    ),
    createResource(
      "SAP FI/CO Consultant",
      "functional",
      "senior_consultant",
      "Finance & Controlling configuration and design"
    ),
    createResource(
      "SAP MM Consultant",
      "functional",
    ...
    createResource(
      ...
      "functional",
      "consultant",
      "Human Capital Management configuration"
    ),
    createResource(
      "SAP PM Consultant",
      "functional",
    ...
    createResource(
      "External SAP Consultant",
      "functional",
      "subcontractor",
      "External functional consultant support"
    ),
    ...
    createResource(
      ...
      "technical",
      "senior_manager",
      "ABAP development workstream lead"
    ),
    createResource(
      "Integration Manager",
      "technical",
      "manager",
      "Integration and interfaces manager"
    ),
    createResource(
      "Senior ABAP Developer",
      "technical",
      "senior_consultant",
      "Complex ABAP development and optimization"
    ),
    ...
    createResource(
      ...
      "technical",
      "consultant",
      "PI/PO, CPI integration configuration"
    ),
    createResource(
      "Technical Analyst",
      "technical",
    ...
    createResource(
      ...
      "basis",
      "principal",
      "SAP landscape architecture and strategy"
    ),
    createResource(
      "SAP Basis Lead",
      "basis",
      "senior_manager",
      "Basis and infrastructure workstream lead"
    ),
    createResource("SAP Basis Manager", "basis", "manager", "Day-to-day basis operations manager"),
    createResource(
      "Senior SAP Basis Admin",
      "basis",
      "senior_consultant",
    ...
    createResource(
      ...
      "basis",
      "consultant",
      "System installation, patching, and support"
    ),
    ...
    createResource(
      ...
      "security",
      "principal",
      "Enterprise security architecture and GRC strategy"
    ),
    createResource(
      "SAP GRC Lead",
      "security",
      "senior_manager",
      "GRC and security workstream lead"
    ),
    createResource(
    ...
    createResource(
      ...
      "security",
      "consultant",
      "Role design and authorization configuration"
    ),
    createResource(
    ...
    createResource(
      ...
      "pm",
      "principal",
      "Overall SAP transformation program leadership"
    ),
    createResource(
      "Senior SAP Project Manager",
      "pm",
      "senior_manager",
      "Multi-workstream project management"
    ),
    createResource(
      "SAP Project Manager",
      "pm",
      "manager",
      "Workstream or phase project management"
    ),
    createResource(
      "SAP Scrum Master",
      "pm",
      "senior_consultant",
      "Agile delivery and sprint facilitation"
    ),
    ...
    createResource(
      ...
      "change",
      "principal",
      "Organizational change strategy and leadership"
    ),
    createResource(
      "Senior OCM Manager",
      "change",
      "senior_manager",
      "Change management workstream lead"
    ),
    createResource(
      "Change Manager",
      "change",
      "manager",
      "Change initiatives and stakeholder management"
    ),
    createResource(
      "Training Manager",
      "change",
    ...
    createResource(
      ...
      "change",
      "consultant",
      "Change communications and messaging"
    ),
    createResource("Change Analyst", "change", "analyst", "Change impact analysis and support"),
    createResource(
      "External OCM Consultant",
      "change",
      "subcontractor",
      "External change management support"
    ),
    ...
    createResource(
      ...
      "qa",
      "principal",
      "Overall quality assurance strategy and governance"
    ),
    ...
    createResource(
      ...
      "qa",
      "senior_consultant",
      "Complex test scenario design and automation"
    ),
    createResource(
      "Test Engineer",
      "qa",
    ...
    createResource(
      ...
      "leadership",
      "principal",
      "Executive IT leadership and digital strategy"
    ),
    createResource(
      "VP of Digital Transformation",
      "leadership",
      "director",
      "Digital transformation vision and roadmap"
    ),
    createResource(
    ...
    createResource(
      ...
      "leadership",
      "director",
      "SAP Center of Excellence leadership"
    ),
    createResource(
    ...
    createResource(
      ...
      "leadership",
      "senior_manager",
      "SAP practice management and capability building"
    ),
  ];
}
