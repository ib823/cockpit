...
export const TEMPLATES: ProjectTemplate[] = [
  ...
  // ============================================================================
  {
    ...
    description:
      "Complete S/4HANA implementation following SAP Activate methodology with all 5 phases: Prepare, Explore, Realize, Deploy, and Run.",
    ...
    phases: [
      {
        ...
        tasks: [
          ...
          {
            name: "Project Plan Finalization",
            durationDays: 6,
            assignee: "Project Manager",
            sortOrder: 6,
          },
      ...
      },
      {
        ...
        tasks: [
          {
            name: "Business Process Workshops",
            durationDays: 15,
            assignee: "Business Analyst",
            sortOrder: 1,
          },
          {
            ...
            durationDays: 20,
            assignee: "Functional Consultant",
            sortOrder: 2,
          },
          {
  ...
  // ============================================================================
  {
    ...
    description:
      "2-week agile sprint with planning, development, testing, and retrospective following Scrum methodology.",
    category: "software",
...

  {
    ...
    name: "Product Launch",
    description:
      "Complete product launch from planning through post-launch optimization with marketing and engineering coordination.",
    category: "software",
  ...
  // ============================================================================
  {
    ...
    description:
      "Commercial building construction project from permits through completion with all major phases.",
  ...
  // ============================================================================
  {
    ...
    name: "Blank Project",
    description:
      "Start from scratch with an empty project. Add your own phases, tasks, and resources.",
    category: "blank",
